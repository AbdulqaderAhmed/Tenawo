          ...
          <div className="card">
            ...
            <div className="card-content">
              ...
              <p>
                ...
                ጤናዎ(TENAWO) የሚባል የሞባይል መተግበሪያና ድህረገፅ እንዲሁም የጥሪ ማዕከል 9456 በመክፈት
                በስራ ላይ ይገኛል። ካምፓኒው ከ 100 በላይ የጤና ተቋማትና ከ 200 በላይ የሃኪሞች አብረዉት
                ይሰራሉ።
              </p>
            </div>
            ...
            <div className="recent-card ">
              <div className="row valign-wrapper">
                <div className="col s2">
                  <img src={recent} alt="" className="circle responsive-img" />
                </div>
                <div className="col s10">
                  <span className="black-text">
                    This is a square image. Add the "circle" className to it to
